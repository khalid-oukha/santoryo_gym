                ...
                @foreach ($offers as $offer)
                    <div
                        ...
                        <div class="text-center">
                            ...
                            <h4 class="mt-2 text-gray-600 line-through dark:text-gray-400">{{ $offer->price + 20 . ',00'}} DH</h4>
                            <h4 class="mt-2 text-4xl font-semibold text-gray-200 dark:text-gray-100">{{ $offer->price }} DH</h4>
                        ...
                        <div class="mt-8 space-y-8">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-orange-500" viewBox="0 0 20 20"
                                    fill="currentColor">
