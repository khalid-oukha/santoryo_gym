                            ...
                            <div class="nk-block nk-block-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h4 class="title nk-block-title">Edit Lesson</h4>
                                                ...
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input value="{{ $lesson->title }}" name="title" type="text" class="form-control"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                ...
                                                                <input value="{{ $lesson->price }}" type="text" name="price" class="form-control"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                ...
                                                                <input value="{{ $lesson->capacity }}" type="text" name="capacity" class="form-control"
                                                                    id="default-05" placeholder="Input placeholder">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <textarea name="description" class="form-control no-resize" id="default-textarea">{{ $lesson->description }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
