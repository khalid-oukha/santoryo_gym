<div x-data="setup()" x-init="$refs.loading.classList.add('hidden');">
    <div class="flex  antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="-translate-x-full"
            ...
            class="fixed inset-y-0 z-30 flex w-90  ">
            <!-- Curvy shape -->
            <svg class="absolute inset-0 w-full h-auto text-white" style="filter: drop-shadow(10px 0 10px #00000030)"
                ...
                <ul class="flex  overflow-y-scroll flex-col flex-1 w-64 p-4 mt-2">
                    ...
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Salles</span>
                        </a>
                    </li>
                    <!---Offer-->
                    ...
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Offers</span>
                        </a>
                    </li>
                    <!---Subscription-->
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span
                                class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Subscription</span>
                        </a>
                    </li>
                    ...
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Lessons</span>
                        </a>
                    </li>
                    <!---Coashs-->
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Coashs</span>
                        </a>
                    </li>
                    ...
                    <li class="mt-0.5 w-full hover:bg-gray-100 rounded-xl group">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Categoris</span>
                        </a>
                    </li>
                    <!---Accounts Management-->
