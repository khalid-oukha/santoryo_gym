    ...
    <nav class="relative px-4 py-4 flex justify-between items-center bg-black">
        ...
        <ul
            ...
            <li><a class="text-sm text-gray-200 hover:text-gray-500" href="{{ route('lessonsList.index') }}">Lessons</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li><a class="text-sm text-gray-200 hover:text-gray-500" href="{{ route('pricing.index') }}">Pricing</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
