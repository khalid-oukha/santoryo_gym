	...
	<div class="mx-auto">
		<div class="flex justify-center px-6 py-12">
			...
			<div class="w-full xl:w-3/4 lg:w-11/12 flex">
				<!-- Col -->
				<img src="{{ URL::asset('assets/images/zorologin.jpg') }}" class="w-full h-auto bg-gray-400 dark:bg-gray-800 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg">
				<!-- Col -->
				<div class="w-full lg:w-7/12 bg-dark-200 dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
					...
					<form action="{{ route('register') }}" method="POST" class="px-8 pt-6 pb-8 mb-4  bg-dark-200 rounded">
						...
						<div class="mb-4 md:flex md:justify-between">
							...
							<div class="md:ml-2">
								<label class="block mb-2 text-sm font-bold text-gray-200 dark:text-white" for="lastName">
                                    Last Name
                                </label>
								<input
                                    class="w-full px-3 py-2 text-sm leading-tight text-gray-800 dark:text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
