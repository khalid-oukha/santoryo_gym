                                ...
                                <div class="relative overflow-hidden rounded-2xl"
                                    ...
                                    <div class="relative z-10 flex-auto p-4">
                                        ...
                                        <div class="flex">
                                            <div class="flex">
                                                <div class="mr-6">
                                                    <p class="mb-0 leading-normal text-white text-sm opacity-80">Card
                                                        Holder</p>
                        ...
                        <div class="flex-auto p-4 pb-0">
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                ...
                                <li
                                    ...
                                    <div class="flex flex-col">
                                        <h6 class="mb-1 font-semibold leading-normal text-sm text-slate-700">February,
                                            10, 2021</h6>
                                ...
                                <li
                                    class="relative flex justify-between px-4 py-2 pl-0 mb-2 bg-white border-0 rounded-xl text-inherit">
                                    <div class="flex flex-col">
                                        <h6 class="mb-1 font-semibold leading-normal text-sm text-slate-700">June, 25,
                                            2019</h6>
                            ...
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                ...
                                <li class="relative flex p-6 mt-4 mb-2 border-0 rounded-xl bg-gray-50">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="mb-2 leading-tight text-xs">Company Name: <span
                                                class="font-semibold text-slate-700 sm:ml-2">Stone Tech
                                                Zone</span></span>
                                        <span class="mb-2 leading-tight text-xs">Email Address: <span
